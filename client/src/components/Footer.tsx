      ...
      <div className="border-y border-white/10 bg-gray-800 overflow-hidden py-4">
        ...
        >
          {[...brands, ...brands].map((brand, i) => (
            <span
              key={i}
              className="text-sm font-bold tracking-widest text-gray-300 uppercase flex-shrink-0 flex items-center gap-3"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mt-4 leading-relaxed text-sm">
              Cửa hàng giày sneaker chính hãng hàng đầu Việt Nam. Cam kết 100%
            ...
            <ul className="space-y-3">
              {[
                ...
                { name: "Hệ thống cửa hàng", href: "/he-thong-cua-hang" },
                {
                  ...
                  href: "/pages/ho-tro-giai-dap-thac-mac#lien-he",
                },
                {
                  name: "Điều khoản & điều kiện",
                  href: "/pages/ho-tro-giai-dap-thac-mac#dieu-khoan",
                },
                {
                  name: "Hợp tác cùng chúng tôi",
                  href: "/pages/ho-tro-giai-dap-thac-mac#hop-tac",
                },
              ].map((item) => (
                <li key={item.name}>
                  <Link
          ...
          <div>
            ...
            <div className="mt-5 space-y-2">
              <div className="flex items-center gap-2 rounded object-cover">
                <Image
                  src="/image_41_487e5803-f4d0-489f-ac14-7b301b6cbb92.avif"
                  alt="Chứng nhận"
                  width={150}
                  height={20}
                />
