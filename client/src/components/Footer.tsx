            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.name}>
                  ...
                  >
                    <span className="w-1.5 h-1.5 rounded-full bg-red-500 opacity-0 group-hover:opacity-100 transition-opacity" aria-hidden="true" />
                    {item.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="grid grid-cols-3 gap-3" aria-labelledby="footer-payment">
              {[
                ...
                <li
                  key={pm.alt}
                  className="w-11 h-11 bg-white/10 hover:bg-white/20 overflow-hidden duration-200 rounded"
                  title={pm.alt}
                >
                  <Image
                    src={pm.src}
