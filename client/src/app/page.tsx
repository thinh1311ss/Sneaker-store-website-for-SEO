...
function HomePageInner() {
  ...
  return (
    <>
      ...
      {/* Loading State */}
      {loading && (
        <section className="py-20" aria-label="Đang tải">
          <div className="container mx-auto px-4 text-center">
            <div
              className="animate-spin w-12 h-12 border-4 border-red-500 border-t-transparent rounded-full mx-auto mb-4"
              role="status"
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-700">
                Hiển thị {Math.min(filteredProducts.length, HOMEPAGE_PRODUCTS_LIMIT)} trong {filteredProducts.length} sản phẩm sneaker chính hãng
              </p>
            </div>
            ...
            {filteredProducts.length > HOMEPAGE_PRODUCTS_LIMIT && (
              <div className="text-center mt-12">
                <Link
                  href="/collections/all"
                  aria-label={`Xem tất cả ${filteredProducts.length} sản phẩm`}
